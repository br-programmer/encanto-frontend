      ...
      <div className="text-center max-w-lg">
        ...
        <div className="mt-8 flex items-center justify-center gap-5">
          <a
            ...
            className="text-foreground-secondary hover:text-logo-primary transition-colors"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            href="https://www.facebook.com/BouquetSemay"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            className="text-foreground-secondary hover:text-logo-primary transition-colors"
          ...
          <a
            href="https://www.tiktok.com/@soydorilu"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TikTok"
            className="text-foreground-secondary hover:text-logo-primary transition-colors"
